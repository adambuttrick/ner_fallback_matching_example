...
def calculate_match(row):
    if row['predicted_ror_id'] and row['predicted_ror_id'] in row['id']:
        return 'Y'
    elif row['predicted_ror_id'] and row['predicted_ror_id'] not in row['id']:
        return 'N'
    elif not row['predicted_ror_id'] and row['id'] == 'NP':
        return 'TN'
    else:
        return 'NP'
